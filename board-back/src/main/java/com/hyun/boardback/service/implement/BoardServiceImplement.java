...
import com.hyun.boardback.repository.SearchLogRepository;
...
public class BoardServiceImplement  implements BoardService{
    ...
    public ResponseEntity<? super GetTop3BoardListResponseDto> getTop3BoardList() {
        ...
        try {
            ...
            boardListViewEntities = boardListViewRepository.findTop3ByWriteDatetimeGreaterThanOrderByFavoriteCountDescReplyCountDescViewCountDescWriteDatetimeDesc(sevenDaysAgo);
