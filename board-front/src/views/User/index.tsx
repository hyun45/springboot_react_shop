                        ...
                        <div className='user-top-my-profile-image-box' onClick={onProfileBoxClickHandler}>
                            {profileImage !== null ?
                                ...
                                <div className='icon-box-large'>
                                    <div className='image-box-icon'></div>
                                </div>
                            }
...
// effect: user email path variable이 변경 될때마다 실행할 함수
        useEffect(() => {
            if(!userEmail) return;
        ...
        return(
            <div id='user-bottom-wrapper'>
                <div className='user-bottom-container'>
                    <div className='user-bottom-title-box'>{isMyPage ? '내 게시글 ' : '게시글 '}<span className='emphasis'>{count}</span></div>
                    <div className='user-bottom-content-box'>
                        {count === 0 ? 
                            <div className='user-bottom-content-nothing'>{'게시글이 없습니다.'}</div> :
